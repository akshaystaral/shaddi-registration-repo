...
public class GujaratishaddiRegistration {
	WebDriver driver;

	public GujaratishaddiRegistration(WebDriver driver) {
		this.driver = driver;
	...
	@FindBy(xpath = "//div[@class='Dropdown-placeholder is-selected'][normalize-space()='Gujarati']")
